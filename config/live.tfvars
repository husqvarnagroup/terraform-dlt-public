...
s3_backend_bucket = "husqvarna-datalake" # Recommended that bucket version control is enabled
...
s3_trusted_prefix = "/mnt/husqvarna-datalake/analytics/usr/miles.hopper/terraform-dlt/trusted"